...
class LlamaBlock(ht.nn.Module):
    def __init__(self, config: LlamaConfig, ds_parallel_configs, layer_idx):
        ...
        self.rmsnorm_1 = ht.nn.HtMultiParallelLayerNorm(hidden_size, get_multi_ds_parallel_config(ds_parallel_configs, 'layernorm1', layer_idx), sequence_parallel=True, eps=config.rms_norm_eps, name=f'rmsnorm1_block{layer_idx}')
        ...
        self.rmsnorm_2 = ht.nn.HtMultiParallelLayerNorm(hidden_size, get_multi_ds_parallel_config(ds_parallel_configs, 'layernorm2', layer_idx), sequence_parallel=True, eps=config.rms_norm_eps, name=f'rmsnorm2_block{layer_idx}')
...
class LlamaModel(LlamaPreTrainedModel):
    def __init__(self, config: LlamaConfig, ds_parallel_configs):
        ...
        self.rmsnorm_f = ht.nn.HtMultiParallelLayerNorm(config.hidden_size, get_multi_ds_parallel_config(ds_parallel_configs, 'layernorm_final'), sequence_parallel=True, eps=config.rms_norm_eps, name='rmsnorm_final')
